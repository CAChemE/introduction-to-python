...
# run cls command on consoleclsa
...
file_handler = logging.handlers.RotatingFileHandler('size_test.log', 
                                                     maxBytes=500, 
                                                     backupCount = 4)

"""                                                        
file_handler = logging.handlers.TimedRotatingFileHandler('time_test.log', 
                                                          when='s', 
                                                          interval = 5, 
                                                          backupCount=4)
"""
...
def f():
    ...
    time_stop = time_start + datetime.timedelta(seconds = 15, minutes = 0)
